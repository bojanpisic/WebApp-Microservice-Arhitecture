...
{
    public class RollbackRACSAdminHandler : IIntegrationEventHandler<RollbackRACSAdmin>
    {
        private readonly IUnitOfWork unitOfWork;

        public RollbackRACSAdminHandler(IUnitOfWork unitOfWork)
        {
            this.unitOfWork = unitOfWork;
        }
        public Task Handle(RollbackRACSAdmin @event)
        {
            Policy
                .Handle<Exception>()
